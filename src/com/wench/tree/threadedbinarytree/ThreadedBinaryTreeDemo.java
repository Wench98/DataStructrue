package com.wench.tree.threadedbinarytree;
...
public class ThreadedBinaryTreeDemo {
    public static void main(String[] args) {
        ...
        System.out.println("使用线索化方式遍历 线索化二叉树——中序");
...
class ThreadedBinaryTree {
    ...
    public void threadedList() {
        ...
        HeroNode node = root;
        while (node != null) {
            //循环的找到leftType==1的结点，第一个找到的就是8号结点
            //后面随着遍历而变化，因为leftType==1时，说明该结点是按照线索化处理后的有效结点
